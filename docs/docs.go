...
const docTemplate = `{
    ...
    "info": {
        ...
        "contact": {
            "name": "API Support",
            "url": "https://campus-project-hub.com/support",
            "email": "support@campus-project-hub.com"
        },
        "license": {
            "name": "MIT",
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.CreateArticleInput"
                        }
                    }
                ],
                "responses": {
        ...
        "/auth/me": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "User profile with gamification",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/categories/{id}": {
            ...
            "delete": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid ID or has projects",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/gamification/config": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Gamification config",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/projects": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Filter by type (free, paid)",
                        "name": "type",
                        "in": "query"
                    },
                    {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.CreateProjectInput"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.CreateCommentInput"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        "type": "string",
                        "default": "all",
                        "description": "Filter type (all, purchases, sales)",
                        "name": "type",
                        "in": "query"
                    }
                ],
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/services.MidtransNotification"
                        }
                    }
                ],
                "responses": {
